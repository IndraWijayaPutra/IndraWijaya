...
// Sertakan file konfigurasi yang mengatur koneksi database
include('../config/config.php'); // Pastikan path ini benar sesuai struktur folder Anda
    ...
    <div class="container mt-4">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p><strong>Status:</strong> <?php echo ucfirst($pemesanan['status_pemesanan']); ?></p>
                <p><strong>Total Harga:</strong> Rp<?php echo $total_harga; ?></p>

                <p>Silakan bayar total harga ke kasir.</p>

                <a href="cetak_nota.php?pemesanan_id=<?php echo $pemesanan['id']; ?>" class="btn btn-primary">Cetak Nota</a>
